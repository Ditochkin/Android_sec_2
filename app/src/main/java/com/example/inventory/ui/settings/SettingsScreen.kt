...
fun SettingsScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            Text(
                text = "Default supplier settings",
                modifier = Modifier
                    .fillMaxWidth()
                    .padding(8.dp),
                fontSize = 22.sp
...
fun DefaultSettings(
    ...
    Column(
        ...
        OutlinedTextField(
            value = uiState.supplierPhone,
            onValueChange = { viewModel.onPhoneChange(it) },
            label = { Text(stringResource(R.string.supplier_phone_default))},
...
fun Flags(
    ...
    Column(
        ...
        Row(
            ...
            Checkbox(
                checked = uiState.enableDataSharing,
                onCheckedChange = { viewModel.onDisableSharingChange(it) },
                modifier = Modifier.padding(end = 8.dp)
            )
            Text(text = stringResource(id = R.string.enable_sharing))
        }
    }
}