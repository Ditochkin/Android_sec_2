...
fun ItemInputForm(
    ...
    Column(
        ...
        OutlinedTextField(
            value = itemDetails.supplier_name,
            onValueChange = { onValueChange(itemDetails.copy(supplier_name = it)) },
        ...
        OutlinedTextField(
            value = itemDetails.supplier_email,
            onValueChange = { onValueChange(itemDetails.copy(supplier_email = it)) },
        ...
        OutlinedTextField(
            value = itemDetails.supplier_phone,
            onValueChange = { onValueChange(itemDetails.copy(supplier_phone = it)) },
